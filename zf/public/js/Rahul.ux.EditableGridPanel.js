        ...
        Ext.apply(grid, {
            ...
            gridEditorCtrlArrowKey: function(combo, el) {
                if (el.keyCode == el.RIGHT || el.keyCode == el.LEFT || el.keyCode == el.UP || el.keyCode == el.DOWN) {
                    ...
                    //Make sure Shift is pressed to avoid shifting of focus just on the Right or Left arrow key.
                    if (!el.shiftKey) {
                        return;
                    }
                    
                } else if (el.keyCode == el.ENTER) {
                ...
                //var cell = grd.getView().getCell(row, col);
                //var cellXtype = cell.getXType();
