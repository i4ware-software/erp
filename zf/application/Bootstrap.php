...
Zend_Loader::loadFile('Core/IBAN.php', $dirs=null, $once=true);
...
$timesheet = new Zend_Config_Xml( APPLICATION_PATH . '/configs/timesheet.xml', APPLICATION_ENV);

$ini = new Zend_Config_Ini( APPLICATION_PATH .'/configs/session.ini', APPLICATION_ENV);

//$company = new Zend_Config_Xml( APPLICATION_PATH . '/configs/company.xml', APPLICATION_ENV);
...
//echo $date->get('dd.MM.yyyy HH:ss');
//echo $date->getTimezone()."<br />";
//$time = $date->getIso();
//echo date("Y-m-d H:s:i",strtotime($time))."<br />";
//echo $date->get('dd.MM.yyyy HH:ss');
...
Zend_Registry::set('date', $date);
//Zend_Registry::set('company', $company);
Zend_Registry::set('timesheet', $timesheet);
