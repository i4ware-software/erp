...
var store = new Ext.data.GroupingStore({
			...
			url: '/zf/public/users/json/index',
				   reader: new Ext.data.JsonReader({root: 'roles',
						...
						{name: 'agreement_accepted', type: 'string'},
						{name: 'agreement_accepted_date', type: 'date', dateFormat:'Y-m-d H:i:s'}]),
...
var grid = new Ext.grid.GridPanel({
                ...
                ,disableIndexes:['user_id','fullname', 'phone', 'active','role','role_id','email','company','agreement_accepted','agreement_accepted_date', 'leader']
                ,minChars:3
                ,autoFocus:true
                ,menuStyle:'radio'
            ...
            xtype: 'booleancolumn',
            header: '<?= $this->agreement_accepted ?>',
            ...
            header   : '<?= $this->agreement_accepted_date ?>', 
            width    : 200, 
            align: 'left',
            dataIndex: 'agreement_accepted_date',
                ...
                Ext.Ajax.request({ 
                    ...
                    , scope: this 
								  ...
								  grid.getSelectionModel().on('rowselect', function(sm, rowIdx, r) {
								       ...
								       Ext.getCmp('phone').setValue(r.get('phone'));
								       Ext.getCmp('userrole').setValue(r.get('role_id'));
								       Ext.getCmp('leader').setValue(r.get('leader'));
