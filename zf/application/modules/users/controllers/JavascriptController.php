...
class Users_JavascriptController extends Zend_Controller_Action
{
	...
	public function indexAction()
    {
		...
		$this->view->agreement_accepted = $translate->_("Users_Agreement_Accepted");
		$this->view->agreement_accepted_date = $translate->_("Users_Agreement_Accepted_Date");
		$this->view->true = $translate->_("Users_True");
		$this->view->false = $translate->_("Users_False");
		$this->view->phone = $translate->_("Users_Phone");
		$this->view->leader = $translate->_("Users_Leader");
		$this->view->yes = $translate->_("Users_Yes");
		$this->view->no = $translate->_("Users_No");
		$this->view->page = $translate->_("Users_Page");
		$this->view->nousers = $translate->_("Users_No_Users");
		$this->view->search = $translate->_("Users_Search");
