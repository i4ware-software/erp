...
class Outsourced_JsonController extends Zend_Controller_Action
{
   ...
   public function __call($method, $args)
    ...
    public function indexAction()
	{
		...
		$uri = 'http://hrmdev.mml-group.eu/zf/public/REST_Server/index.php?action=active&key=TEST';
		...
		echo $core->gzdecode($array_expression[1]);
