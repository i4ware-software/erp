...
function eraseCookie(name) {
 ...
 Ext.onReady(function() {
            ...
            var store = new Ext.data.Store({
                    url: '/zf/public/profitcenters/json/index',
                    reader: new Ext.data.JsonReader({root: 'profitcenters',
                        totalProperty: 'totalCount',id: 'kustannuspaikka_id'}, 
                            [{name: 'kustannuspaikka_id',type: 'int'},
                            {name: 'kustannuspaikka_nimi',type: 'string'}]),
                            baseParams: { "limit":50 },
                            sortInfo:{field: 'kustannuspaikka_id', direction: "DESC"},
                            remoteSort: true
                        });
            ...
            function saveEdit (Grid_Event) {
				Ext.Ajax.request({
					...
					, url: '/zf/public/profitcenters/json/edit'
					, params: { 
						task: "edit"
						, key: 'kustannuspaikka_id' 
						, keyID: Grid_Event.record.data.kustannuspaikka_id
			...
			function handleDelete() {
				...
				Ext.Ajax.request({
					waitMsg: '<?= $this->sending ?>'
					, url: '/zf/public/profitcenters/json/delete'
					, params: { 
						task: "delete"
            ...
            var newform = new Ext.FormPanel( {
                id : Ext.id(),
                labelWidth : 120,
                url : "/zf/public/profitcenters/json/createnew",
                frame : false,
                                ...
                                buttons : [
                                        {
                                            text : '<?= $this->submit ?>',
                                            handler : function() {
                                                var url = "/zf/public/profitcenters/json/createnew";
            ...
            var replaceform = new Ext.FormPanel( {
                id : Ext.id(),
                labelWidth : 120,
                url : "/zf/public/profitcenters/json/import",
                frame : false,
                bodyStyle : 'padding:5px 5px 0 0',
                width : 460,
                border : false,
                                ...
                                buttons : [
                                        {
                                            text : '<?= $this->submit ?>',
                                            handler : function() {
                                                var url = "/zf/public/profitcenters/json/import";
    ...
    var grid = new Ext.grid.EditorGridPanel({
        ...
        cm: new Ext.grid.ColumnModel({
            ...
            },
            {
                ...
                sortable : true,
                locked:true, 
                dataIndex: 'kustannuspaikka_nimi',
        ...
        tbar: [
                ...
                handler: function () {
                    ...
                    iconCls: 'refresh-icon',
                    handler: function () {
                    	window.location = '/zf/public/profitcenters/json/export';
                }},
                {
                    text: '<?= $this->import ?>',
