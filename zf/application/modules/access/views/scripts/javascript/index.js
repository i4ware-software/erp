...
var store = new Ext.data.GroupingStore({
			...
			sortInfo: {field: 'module_controller',direction: 'ASC'},
			url: '/zf/public/access/json/index',
				   reader: new Ext.data.JsonReader({root: 'roles',
						totalProperty: 'totalCount',
						id: 'access_id'}, 						
						[{name: 'access_id', type: 'int'},
						{name: 'role_name', type: 'string'},
						{name: 'role_inherit', type: 'string'},
						{name: 'access', type: 'string'},
						{name: 'module', type: 'string'},
						{name: 'action', type: 'string'},
						{name: 'module_controller', type: 'string'}]),
...
var grid = new Ext.grid.GridPanel({
                    ...
                    autoScroll:true                  
								  ...
								  colModel: new Ext.grid.ColumnModel([new Ext.grid.RowNumberer(),{header: 'ID',
																	  ...
																	  hidden: false,
																	  locked: false},
																	  {header: '<?= $this->rolename ?>',
																	  dataIndex: 'role_name',
																	  width: 80,
																	  sortable: false,
																	  locked: false},
																	  {header: '<?= $this->roleinherit ?>',
																	  dataIndex: 'role_inherit',
																	  width: 80,
																	  sortable: false,
																	  locked: false},
																	  {header: '<?= $this->module ?>',
	...
	//Ext.get('hd').getHeight();
                ...
                Ext.Ajax.request({ 
                    ...
                    , url: '/zf/public/access/json/edit' 
                    , params: {  
                        task: "edit_access" 
                        , key: 'access_id' 
                        , keyID: grid.getSelectionModel().getSelected().get('access_id')
                        , field: 'access' 
                        , value: grid.getSelectionModel().getSelected().get('access')
                        } 
