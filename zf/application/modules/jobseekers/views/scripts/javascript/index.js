	 ...
	 function years(val) {               
         ...
         return '<span style="color:#008800;">' + val + '<?= $this->years ?></span>';
            ...
            var store = new Ext.data.Store({
                url: '/zf/public/jobseekers/json/index',
            ...
            var storeQualifications = new Ext.data.Store({
                url: '/zf/public/jobseekers/json/qualifications',
            ...
            var storeEducation = new Ext.data.Store ({
				proxy: new Ext.data.HttpProxy ({ 
					url: '/zf/public/jobseekers/json/education',
					scope: this
				})
				, baseParams: {
					task: "education"
          ...
          var storeStartplace = new Ext.data.Store ({
				proxy: new Ext.data.HttpProxy ({ 
					url: '/zf/public/jobseekers/json/startplace',
					scope: this
				})
				, baseParams: {
					task: "startplace"
        ...
        storeStartplace.load();
            ...
            var grid = new Ext.grid.EditorGridPanel({
                ...
                tbar: [
                        '-',                         
                        {
	                        ...
	                        {
		                        id: 'new-career-grid',
	                        	text: '<?= $this->new_career ?>',
		                        tooltip: '<?= $this->new_career_tooltip ?>',
		                        iconCls: 'refresh-icon',
		                        disabled: false,
		                        handler: createNT
		                     },
			                 ...
			                 {
			                        id: 'delete-career-grid',
		                        	text: '<?= $this->delete_career ?>',
			                        tooltip: '<?= $this->delete_career_tooltip ?>',
			                        iconCls: 'refresh-icon',
			                        disabled: true,
			                        handler: deleteCR
			                 },
			                 ...
			                 },
		                     {
		                            ...
		                            handler: function () {
		                                ...
		                                window.location = '/zf/public/jobseekers/download.' + encoded_keys + '.pdf';
            ...
            function deleteCR() {
				...
				Ext.Ajax.request({
					...
					, url: '/zf/public/jobseekers/json/deletecr'
					, params: { 
						task: "deletecr"
            ...
            var replaceform = new Ext.FormPanel( {
                id : Ext.id(),
                labelWidth : 120,
                url : "/zf/public/jobseekers/json/replace",
                frame : false,
                                ...
                                buttons : [
                                        {
                                            text : '<?= $this->submit ?>',
                                            handler : function() {
                                                var url = "/zf/public/jobseekers/json/replace";
            ...
            var replaceqaform = new Ext.FormPanel( {
                id : Ext.id(),
                labelWidth : 120,
                url : "/zf/public/jobseekers/json/replaceqa",
                frame : false,
                bodyStyle : 'padding:5px 5px 0 0',
                width : 460,
                border : false,
                                ...
                                buttons : [
                                        {
                                            text : '<?= $this->submit ?>',
                                            handler : function() {
                                                var url = "/zf/public/jobseekers/json/replaceqa";
           ...
           function moveCR() {
				...
				Ext.Ajax.request({
					waitMsg: '<?= $this->sending ?>'
					, url: '/zf/public/jobseekers/json/movecr'
					, params: { 
						task: "movecr"
						, deleteKeys: encoded_keys
						, key: 'employee_id'
                 ...
                 tbar: [
		                 ...
		                 },
                         {
 	                        ...
 	                        handler: function () {
 	                            ...
 	                            window.location = '/zf/public/jobseekers/download_certificate.' + encoded_keys + '.pdf';
            ...
            function deleteQA() {
				...
				Ext.Ajax.request({
					waitMsg: '<?= $this->sending ?>'
					, url: '/zf/public/jobseekers/json/deleteqa'
					, params: { 
						task: "deleteqa"
						, deleteKeys: encoded_keys
					...
					, success:function(response,options){
		            	...
		            	Ext.getCmp('replace-qualification-grid').disable();
		            	gridQualifications.selModel.clearSelections();
		            	storeQualifications.proxy.conn.url = "/zf/public/jobseekers/json/qualifications?employee_id="+json.employee_id;
		            	gridQualifications.store.clearData();
		                gridQualifications.view.refresh();
		            	storeQualifications.reload();
                      }
            ...
            function saveQualificationGridEdit (Grid_Event) {            
                ...
                Ext.Ajax.request({
                    ...
                    , url: '/zf/public/jobseekers/json/qualificationedit'
                    , params: { 
                        task: "edit"
                        , key: 'id' 
            ...
            var newform = new Ext.FormPanel( {
                id : Ext.id(),
                labelWidth : 120,
                url : "/zf/public/jobseekers/json/createnew",
                frame : false,
                bodyStyle : 'padding:5px 5px 0 0',
                width : 460,
                border : false,
                                ...
                                buttons : [
                                        {
                                            text : '<?= $this->submit ?>',
                                            handler : function() {
                                                var url = "/zf/public/jobseekers/json/createnew";
            ...
            function saveGridEdit (Grid_Event) {            
                ...
                Ext.Ajax.request({
                    waitMsg: 'Saving changes...'
                    , url: '/zf/public/jobseekers/json/gridedit'
                    , params: { 
                        task: "edit"
                        , key: 'id' 
            ...
            grid.getSelectionModel().on('rowselect', function(sm, rowIdx, r) {
            	...
            	storeQualifications.proxy.conn.url = "/zf/public/jobseekers/json/qualifications?employee_id="+r.get('employee_id');
            	gridQualifications.store.clearData();
                gridQualifications.view.refresh();
            	storeQualifications.reload();
            ...
            var newqualification = new Ext.FormPanel( {
                id : Ext.id(),
                labelWidth : 200,
                url : "/zf/public/jobseekers/json/createnewqualification",
                frame : false,
                bodyStyle : 'padding:5px 5px 0 0',
                width : 470,
                height : 280,
                                ...
                                buttons : [
                                        {
                                            text : '<?= $this->submit ?>',
                                            handler : function() {
                                                var url = "/zf/public/jobseekers/json/createnewqualification";
